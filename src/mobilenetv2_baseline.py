"""
MobileNetV2 baseline for binary arch recognition in architectural heritage images.
...
- Partial fine-tuning: final feature block (features[18]) + classifier
- Random seed: 42
...
def main():
    ...
    parser.add_argument("--output-dir", default="outputs/mobilenetv2_baseline")
    ...
    assert total == 2_226_434
    assert trainable == 414_722
    assert frozen == 1_811_712

    output_dir = Path(args.output_dir)
    output_dir.mkdir(parents=True, exist_ok=True)
    checkpoint_path = output_dir / "best_mobilenetv2_baseline.pth"
            ...
            if val_loss < best_val_loss:
                ...
                torch.save({
                    ...
                    "configuration": {
                        ...
                        "fine_tuning": "features[18] + classifier",
                        "augmentation": "none",
                    },
                }, checkpoint_path)
            else:
